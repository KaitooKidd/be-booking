...
public class FirebaseAuthServiceImpl implements FirebaseAuthService {
    ...
    public void sendVerificationEmail(String email, String content) {
        ...
        kafkaEmailProducer.sendVerificationEmail(email, content);
